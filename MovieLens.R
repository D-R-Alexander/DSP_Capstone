...
#Q2a: How many zeros were given as ratings in the edx dataset?
sum(edx$rating == 0)

#Q2a: How many threes were given as ratings in the edx dataset?
sum(edx$rating == 3)
...
#Q8 True or False: In general, half star ratings are less common than whole 
